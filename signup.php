...
<body class="hold-transition register-page">
  <img href="index.php" src="images/logo2.png" style="position: absolute; left:42%; top:0px; max-height: 80px !important; width: auto; ">
<div style="margin-top: 80px;" class="register-box">
  	<?php
